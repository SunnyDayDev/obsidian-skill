...
Define how the Obsidian CLI skill is packaged and distributed as a Claude Code plugin: a valid plugin manifest, a marketplace entry for one-command installation, semantic versioning of releases, and clear install/update/uninstall documentation.
