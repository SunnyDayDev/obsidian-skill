...
Define how the project repository is governed: a public GitHub repository with baseline documentation, a GitFlow branching model, a protected `main` branch, continuous integration on pull requests, and tagged releases recorded in a changelog.
